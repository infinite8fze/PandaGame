...
const stripePromise = loadStripe('pk_test_51Qrf3CQpaDP4McHwJ7BZZvstX3PFZpDewIt0jTOEsi5hyoXuoNThPqsdNKlbm9drYsYxFoju0pVAemffWb9Y6Vfa00jyLRSh5i');
...
const plans = [
  ...
  },
  {
    ...
    price: '$19.99',
    interval: 'month',
    features: ['Access to pro features', 'Unlimited projects', 'Priority support', 'Advanced analytics'],
    icon: Crown,
...
export function SubscriptionPage() {
  ...
  const handleSubscribe = async (priceId: string, planName: string) => {
    try {
      ...
      // For testing purposes, we'll use a test session ID
              ...
              >
                ...
                <div className="px-6 pt-6 pb-8">
                  <button
                    ...
                    className={`w-full bg-indigo-600 border border-transparent rounded-md py-2 px-4 text-sm font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors ${
                      loading === plan.name
