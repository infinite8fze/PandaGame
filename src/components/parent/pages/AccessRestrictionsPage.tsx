  ...
  return (
    ...
    >
      <div className="w-5 h-5 mr-2">
        {isSelected && <img src="/svg/checked.svg" alt="Selected" className="w-5 h-5" />}
      </div>
...
export function AccessRestrictionsPage({ onBack }: AccessRestrictionsPageProps) {
  ...
  const [selectedDevices, setSelectedDevices] = useState<string[]>(['mobile', 'tablet', 'web']);
          ...
          <div className="flex items-center mt-8 mb-10">
            ...
            >
              <img 
                ...
                style={{ filter: "invert(35%) sepia(93%) saturate(1103%) hue-rotate(101deg) brightness(92%) contrast(101%)" }}
              />
            </button>
            <h2 className="text-3xl font-bold text-[#229654]">Access Restrictions</h2>
          </div>

          {/* Content */}
          <div className="flex-1 overflow-y-auto px-4 scrollbar-custom">
            <div className="max-w-2xl mx-auto">
              <h3 className="text-2xl font-bold text-[#1F2020] mb-6">1. Usage Restrictions</h3>
              {/* Description */}
              <p className="text-[#1F2020] text-lg mb-10">
                Set specific dates and time periods for game usage to ensure balanced playtime.
              </p>
              ...
              <div className="p-6 mb-12">
                ...
                <div className="relative w-full max-w-md mx-auto h-64">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 text-center">
                    ...
                    <div className="text-xl text-[#229654]">
                      in Day
                    </div>
              ...
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6 text-center">Allowed Days</h3>
              ...
              {/* Device Restrictions */}
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">2. Device Restrictions</h3>
              ...
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">3. Feature Access Restrictions</h3>
                ...
                <FeatureOption
                  ...
                  onToggle={() => setExternalLinksRestricted(!externalLinksRestricted)}
                />
              </div>

              {/* Remote Parental Control */}
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">4. Remote Parental Control</h3>
              ...
              <div className="flex justify-center mt-8 mb-12">
                <button
                  className="bg-[#229654] text-white px-8 py-3 rounded-lg text-xl font-bold hover:bg-[#1b7a44] transition-colors shadow-lg"
                >
                  Save Restrictions
                </button>
              </div>
