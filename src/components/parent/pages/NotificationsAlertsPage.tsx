...
function FeatureOption({ title, description, isEnabled, onToggle }: FeatureOptionProps) {
  return (
    <div className="flex items-start mb-6">
      ...
      >
        <div className="w-5 h-5">
          {isEnabled && <img src="/svg/checked.svg" alt="Enabled" className="w-5 h-5" />}
        </div>
      </button>
...
export function NotificationsAlertsPage({ onBack }: NotificationsAlertsPageProps) {
  const [excessiveUseEnabled, setExcessiveUseEnabled] = useState(true);
  const [inappropriateContentEnabled, setInappropriateContentEnabled] = useState(true);
          ...
          <div className="flex items-center mt-8 mb-10">
            ...
            >
              <img 
                ...
                style={{ filter: "invert(65%) sepia(54%) saturate(1552%) hue-rotate(346deg) brightness(101%) contrast(101%)" }}
              />
            </button>
            <h2 className="text-3xl font-bold text-[#FF9E2D]">Notifications & Alerts</h2>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 scrollbar-custom">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-[#1F2020] text-lg mb-10 flex items-center">
                ...
                Configure how and when you receive notifications about your child's activity
              </p>

              {/* Excessive Use */}
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">1. Excessive Use</h3>
              ...
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">2. Inappropriate Content</h3>
                ...
                <FeatureOption
                  ...
                  onToggle={() => setInappropriateContentEnabled(!inappropriateContentEnabled)}
                />
              </div>

              {/* Weekly Report Summary */}
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">3. Weekly Report Summary</h3>
              ...
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">4. Extra Time for Children</h3>
              ...
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">5. Notification Preferences</h3>
                
                <div className="bg-white p-6 rounded-xl shadow-sm border border-[#FFE0B2]">
                  <div className="mb-4">
                    <h4 className="text-lg font-bold text-[#1F2020] mb-2">Notification Method</h4>
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#1F2020] mb-2">Notification Frequency</h4>
                    <div className="flex flex-wrap gap-3">
                      <button className="px-4 py-2 bg-[#FF9E2D] text-white rounded-lg font-medium">
                        Immediate
                      </button>
              ...
              <div className="flex justify-center mt-8 mb-12">
                <button
                  className="bg-[#FF9E2D] text-white px-8 py-3 rounded-lg text-xl font-bold hover:bg-[#E08D26] transition-colors shadow-lg"
                >
