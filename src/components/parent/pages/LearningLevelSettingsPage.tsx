...
export function LearningLevelSettingsPage({ onBack }: LearningLevelSettingsPageProps) {
  const [selectedDifficulty, setSelectedDifficulty] = useState<string>('beginner');
  const [selectedSubjects, setSelectedSubjects] = useState<string[]>(['reading', 'math']);
          ...
          <div className="flex items-center mt-8 mb-10">
            ...
            >
              <img 
                ...
                style={{ filter: "invert(35%) sepia(58%) saturate(2573%) hue-rotate(230deg) brightness(101%) contrast(98%)" }}
              />
            </button>
            <h2 className="text-3xl font-bold text-[#6A6AF1]">Learning Level Settings</h2>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 scrollbar-custom">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-[#1F2020] text-lg mb-10">
                Content is set by age by default, but parents can adjust difficulty for a personalized learning experience
              </p>

              {/* Difficulty Level Selection */}
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">1. Difficulty Level Selection</h3>
              ...
              {/* Subjects Selection */}
              <div className="p-6 mb-8">
                <h3 className="text-2xl font-bold text-[#1F2020] mb-6">2. Subjects Selection</h3>
              ...
              <div className="flex justify-center mt-8">
                <button
                  className="bg-[#6A6AF1] text-white px-8 py-3 rounded-lg text-xl font-bold hover:bg-[#5959D9] transition-colors"
                >
                  Save Settings
                </button>
              </div>
